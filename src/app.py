...
activities = {
    ...
    "Drama Club": {
        "description": "Prepare performances, practice acting, and stage productions",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Olympiad": {
        "description": "Train for math competitions and solve challenging problems",
        "schedule": "Fridays, 3:30 PM - 4:30 PM",
        "max_participants": 16,
        "participants": ["noah@mergington.edu", "ava@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments, research, and science projects",
